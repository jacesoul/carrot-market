...
const Home: NextPage = () => {
  return (
    <div className=" bg-slate-400 py-20 px-20 grid gap-10 mx-auto">
      <div className=" bg-white sm:bg-red-400 md:bg-teal-400 lg:bg-indigo-400 xl:bg-yellow-400 2xl:bg-pink-400 p-6 rounded-3xl shadow-xl flex flex-col">
