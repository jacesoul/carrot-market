...
const CommunityPostDetail: NextPage = () => {
  return (
    <div>
      <span className=" inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800 ml-4 my-2.5 ">
        동네질문
      </span>
      ...
      <div className=" px-4">
        <textarea
          ...
          id="description"
          rows={4}
          placeholder="Anwer this question!"
        ></textarea>
